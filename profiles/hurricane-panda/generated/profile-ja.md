...
| Deep Panda | overlaps-with | 共有alias: Black Vine | 低 | `source--actor-mapping-workbook` |
| ZIRCONIUM | overlaps-with | 共有alias: APT31, Zirconium, ZIRCONIUM | 低 | `source--actor-mapping-workbook` |
...
|---|---|---|---|---|---|
| gtig-threat-actor-naming | TIDE CASTLE | single-alias-intersection | 中 |  | https://cloud.google.com/blog/topics/threat-intelligence/updated-cyber-threat-actor-naming-system |
...
| misp-360net | 一致なし |  |  |  |  |
| misp-tidal-groups | ZIRCONIUM | single-alias-intersection | 中 | CN |  |
...
|---|---|---|---|---|---|---|---|
| Op. Poisoned Hurricane | Hurricane Panda | 情報なし | 情報なし | 情報なし | 情報なし | 情報なし | 中 |
