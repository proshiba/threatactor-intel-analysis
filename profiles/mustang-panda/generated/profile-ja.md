...
| malware--daily-2e2fae64b72baefca8c8 | MINIRECON | tech-memo日次IOCでMustang Pandaによる使用が報告されたマルウェア。 | 2026-06-28 | 2026-06-28 | 高 | `source--daily-f24514e21b73cfc154c2` |
...
| Mustang Panda、ZOHOMURKとMINIRECONでインドの政府・エネルギー部門を標的化 | reported-activity | 2026-06-28 | 2026-06-28 | Acronis TRUは、Mustang Pandaがインド政府機関を狙う2つの同時進行キャンペーンを追跡した。 標的はインドの水力発電部門と、台湾政府機関との協力協定(MOU)に関わる政府機関とされる。 攻撃ではSHARDLOADER、MINIRECON、ZOHOMURKという新たなマルウェア群が使われた。 ZOHOMURKは正規クラウドサービスZoho WorkDriveをC2、データ流出、遠隔タスク実行に悪用する。 TRUはインド政府部門の複数侵害システムを特定し、CERT-Inと連携して緩和と被害通知を支援した。 | 高 | `source--daily-f24514e21b73cfc154c2` |
...
| source--daily-f24514e21b73cfc154c2 | Mustang Panda、ZOHOMURKとMINIRECONでインドの政府・エネルギー部門を標的化 | acronis.com | 2026-07-01 | https://www.acronis.com/en/tru/posts/mustang-panda-targets-indias-government-and-energy-sectors/ | osint-report | TLP:CLEAR | 高 |
