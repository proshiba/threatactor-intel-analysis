# Syrian Electronic Army (SEA) 脅威アクタープロファイル
...
Syrian Electronic Army (SEA)の標準化プロファイル。リポジトリ内の専用資料1件とMITRE ATT&CK、アクターマッピング表を基礎情報としている。

## アクター名とAlias

- 正規名: **Syrian Electronic Army (SEA)**
- 初回観測: 不明
- 最終観測: 不明
- 活動状態: unknown
...
| misp-threat-actor | Deadeye Jackal | single-alias-intersection | 中 | SY | https://en.wikipedia.org/wiki/Syrian_Electronic_Army |
