...
|---|---|
| Adversary |  |
| Capability | Spear-phishing, URL “web bugs” and scheduled tasks to automate credential harvesting |
| Infrastructure |  |
| Victim | Upstream providers (e.g., law firms and managed service providers) to support additional intrusions against high-profile assets |
| Socio-political |  |
...
|---|---|---|---|---|---|---|
| malware--spear-phishing | Spear-phishing | The actor-mapping workbook lists this software or tool. | 不明 | 不明 | 中 | `source--actor-mapping-workbook` |
| malware--url-web-bugs-and-scheduled-tasks-to-automate-credential-harvesting | URL “web bugs” and scheduled tasks to automate credential harvesting | The actor-mapping workbook lists this software or tool. | 不明 | 不明 | 中 | `source--actor-mapping-workbook` |
...
|---|---|---|---|---|---|---|---|
| 中国関与のAPT31、クラウドサービスを悪用してロシアITを秘匿攻撃 | Judgement Panda | 情報なし | 情報なし | 情報なし | ロシア | 被害事例: 中国関与のAPT31、クラウドサービスを悪用してロシアITを秘匿攻撃 | 中 |
