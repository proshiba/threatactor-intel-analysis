...
|---|---|---|---|---|---|---|---|
| 北朝鮮のハッカーAPT45は、サイバースパイ活動からランサムウェア攻撃へシフト | APT45 | 情報なし | 情報なし | 情報なし | 情報なし | 被害事例: 北朝鮮のハッカーAPT45は、サイバースパイ活動からランサムウェア攻撃へシフト | 高 |
| 北朝鮮のハッカーがVPN更新の脆弱性を悪用してマルウェアをインストール | APT45 | 情報なし | T1190 Exploit Public-Facing Application | 情報なし | 韓国, 製造・産業 | 被害事例: 北朝鮮のハッカーがVPN更新の脆弱性を悪用してマルウェアをインストール | 中 |
