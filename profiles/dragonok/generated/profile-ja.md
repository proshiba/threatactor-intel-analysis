...
|---|---|---|---|---|---|
| Dragon Castling | catalog | overlapping | 中 | `source--actor-mapping-workbook` | Alias scope must be reviewed before publication. |
...
| 対象 | 関係 | 説明 | 確度 | 証拠 |
|---|---|---|---|---|
| Moafee | overlaps-with | Due to overlapping TTPs, including similar custom tools, [DragonOK](https://attack.mitre.org/groups/G0017) is thought to have a direct or indirect relationship with the threat group [Moafee](https://attack.mitre.org/groups/G0002). | 高 | `source--mitre-attack-19-2` |
...
| misp-mitre-enterprise-intrusion-set | DragonOK - G0017 | mitre-external-id | 高 |  | http://researchcenter.paloaltonetworks.com/2015/04/unit-42-identifies-new-dragonok-backdoor-malware-deployed-against-japanese-targets/<br>https://attack.mitre.org/groups/G0017<br>https://web.archive.org/web/20210920193513/https://www.fireeye.com/content/dam/fireeye-www/global/en/current-threats/pdfs/wp-operation-quantum-entanglement.pdf |
...
| misp-360net | 一致なし |  |  |  |  |
| misp-tidal-groups | DragonOK | canonical-name | 高 | CN |  |
...
| regions | 東アジア | 台湾、日本で確認された標的・被害事例を東アジアとして集約した地域表示。 | 不明 | 不明 | 中 | `source--actor-mapping-workbook`, `source--mitre-attack-19-1`, `source--mitre-attack-19-2`, `source--target-audit-etda-threat-group-cards` |
