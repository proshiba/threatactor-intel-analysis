...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 被害事例: Black Bastaランサムウェアグループ、戦略的攻撃のために再編成 | 非公開 | aggregate | multiple-organizations | reported |  |  |  | メール／メールアカウント | encryption: Black Bastaランサムウェアグループ、戦略的攻撃のために再編成 | 不明 | 不明 | 2024-11-26 | 中 | `source--daily-3db6fd943f36fd38310f` |
