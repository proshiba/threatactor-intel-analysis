...
| 対象 | 関係 | 説明 | 確度 | 証拠 |
|---|---|---|---|---|
| HeartlessSoul | suspected-shared-operators | Kaspersky assesses with medium confidence that GOFFEE and HeartlessSoul may be operated by the same attackers, while explicitly noting that their toolsets differ substantially. | 中 | `source--kaspersky-goffee-warprat-powertaskel-v2-2026` |
...
| ID | 名称 | 説明 | 初回 | 最終 | 確度 | 証拠 |
|---|---|---|---|---|---|---|
| tool--goffee-mythic | Mythic | 公開のポストエクスプロイトフレームワーク。GOFFEE はこのフレームワーク向けの独自エージェント(PowerTaskel、PowerTaskel v2、バイナリ Mythic エージェント、BI.ZONE が挙げる QwakMyAgent)を開発して用いる。BI.ZONE は公開エージェント Poseidon の併用も記録している。 | 2023 | 2026-06 | 高 | `source--bizone-paper-werewolf-destructive-2024`, `source--kaspersky-goffee-q2-containers-2026`, `source--kaspersky-goffee-recent-attacks-2025`, `source--kaspersky-goffee-warprat-powertaskel-v2-2026` |
| tool--goffee-powershell | PowerShell | Windows標準のコマンド・スクリプト環境。Kasperskyは2026年第2四半期CampaignでInvoke-WebRequestによる取得とPowerShell実行を直接記述している。 | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
| tool--goffee-certutil | certutil | Windows標準の証明書ユーティリティ。2026年第2四半期Campaignでは、curl、wget、Invoke-WebRequestと並ぶファイル取得手段として使用された。 | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
| tool--goffee-mshta | mshta.exe | 2026年第2四半期Campaignで攻撃者が持ち込んで改名し、HTA実行に用いたWindows標準バイナリ。 | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
| tool--goffee-installutil | InstallUtil.exe | 2026年第2四半期Campaignでサービス永続化とコード実行に悪用された.NET Frameworkの正規ユーティリティ。 | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
| tool--goffee-pgadmin | pgAdmin | Kasperskyは2026年第2四半期Campaignで、攻撃者がpgAdminのソースを改変して悪性動作を組み込んだと報告した。 | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
| tool--goffee-chisel | Chisel | 被害 IT インフラへの冗長なアクセス経路を確保するために使用する公開トンネリングツール。BI.ZONE は mastc.exe client --tls-skip-verify -v https://[redacted]:49611 R:socks の実行を記録している。 | 不明 | 不明 | 高 | `source--bizone-paper-werewolf-destructive-2024` |
...
| GOFFEEによる偽Acrobat Reader更新を用いたWarpRATとPowerTaskel v2の配布 | espionage-campaign | 2026-03 | 2026-03 | 2026-08-28 | target--goffee--country--russia, target--goffee--region--cis, target--goffee--region--europe, target--goffee--sector--manufacturing | malware--goffee-powertaskel-v2, malware--goffee-warprat | tool--goffee-mythic, tool--goffee-inno-setup | ttp--goffee--encrypted-channel, ttp--goffee--proxy, ttp--goffee--sandbox-evasion, ttp--goffee--spearphishing-link, ttp--goffee--user-execution-installer | victim--activity-rule--d86163e519a5c281599b | Kasperskyは2026年3月、GOFFEEが悪性リンクを含むPDFを添付したメールを送るキャンペーンを観測した。PDFはAcrobat Readerが古く更新が必要であるという体裁の偽の通知を内部に描画し、「更新をインストール」ボタンからntpluck[.]onlineの長大なパスへ誘導する。遷移先ではAdobe_Reader_RU.zipが配布され、内部のInno Setup 6.7.0 (Unicode)製ドロッパーAdobe_Acrobat_Reader_Plugin_ru.exeが、WarpRAT本体のadbp.exe、おとりPDF「ОФИЦИАЛЬНЫЙ ЗАПРОС о предоставлении сведений о потребности в особочистой химической продукции」、およびinstall_script.issを展開する。インストールスクリプトはWarpRATを起動した直後におとりPDFを開く。当該WarpRAT検体はC2にntpsum[.]online、ポート443、TLS有効、POST、sleepTime 314(揺らぎ15)、anti-VM有効の設定を持ち、調査時点でC2が稼働していたためKasperskyは実際の通信を記録している。同キャンペーンではもう1つのバックドアとして軽量なPowerShell製Mythicエージェント(PowerTaskel v2)が展開され、get_tasking要求に対してサーバがコマンド名と実行コードの双方を送り、応答をpost_responseとして返す対話が確認された。 | 高 | `source--kaspersky-goffee-warprat-powertaskel-v2-2026` |
| GOFFEEによるリモートテンプレート・コンテナ環境を用いた2026年第2四半期キャンペーン | espionage-campaign | 2026-04 | 2026-06 | 2026-07-29 | target--goffee--country--russia, target--goffee--country--belarus, target--goffee--sector--technology |  | tool--goffee-mythic, tool--goffee-powershell, tool--goffee-certutil, tool--goffee-mshta, tool--goffee-installutil, tool--goffee-pgadmin | ttp--goffee-q2-template-injection, ttp--goffee-q2-wmi, ttp--goffee-q2-powershell, ttp--goffee-q2-ingress-tool-transfer, ttp--goffee-q2-mshta, ttp--goffee-q2-installutil, ttp--goffee-q2-reflective-code-loading |  | Kasperskyは2026年第2四半期、GOFFEEが主にロシアのテクノロジー企業を標的とし、ベラルーシにも対象を拡大した新たなフィッシングCampaignを観測した。SMB/WebDAV上のリモートテンプレート注入、curl・wget・certutil・Invoke-WebRequest、持ち込んで改名したmshta.exe、User-Agentによるデータ送信、InstallUtilを用いたサービス永続化、pgAdminのソース改変を使用した。Linuxコンテナでは/opt/bitnami/scripts/rabbitmq/setup.shを通じた可能性が高いMythicエージェントの導入とmemfd_create実行を確認した。公開IOCは24ドメイン、4 IPv4、58 MD5の計86個である。個別マルウェアファミリの帰属が資料で示されないため、PowerTaskel/PowerModul/PowerTaskel v2をこのCampaignへ結び付けない。 | 高 | `source--kaspersky-goffee-q2-containers-2026` |

### 活動別ダイヤモンドモデル

| 活動 | 攻撃者 | マルウェア | ツール | TTP | インフラ | 標的属性 | 被害事例 | 確度 |
|---|---|---|---|---|---|---|---|---|
| GOFFEEによる改変Owowa IISモジュールの設置 | GOFFEE | Owowa | 情報なし | T1573.002 Asymmetric Cryptography, T1505.004 IIS Components, T1056.003 Web Portal Capture | 情報なし | 情報なし | 情報なし | 高 |
| Paper Werewolfによるマクロ文書を用いた一連のキャンペーンと破壊的行為 | GOFFEE | Owowa, PowerModul, PowerTaskel, QwakMyAgent | 情報なし | T1059.001 PowerShell, T1583.001 Domains, T1583.003 Virtual Private Server, T1485 Data Destruction, T1140 Deobfuscate/Decode Files or Information, T1587.001 Malware, T1027.007 Dynamic API Resolution, T1027.009 Embedded Payloads, T1027.013 Encrypted/Encoded File, T1008 Fallback Channels, T1027.011 Fileless Storage, T1564.001 Hidden Files and Directories, T1105 Ingress Tool Transfer, T1570 Lateral Tool Transfer, T1588.002 Tool, T1566 Phishing, T1059.001 PowerShell, T1547.001 Registry Run Keys / Startup Folder, T1608.001 Upload Malware, T1082 System Information Discovery, T1033 System Owner/User Discovery, T1529 System Shutdown/Reboot, T1204.002 Malicious File, T1059.005 Visual Basic, T1071.001 Web Protocols | C2 とマルウェア配置に用いる VPS | 政府・行政, メディア・報道, エネルギー, 金融 | 被害事例: Paper Werewolfによるマクロ文書を用いた一連のキャンペーンと破壊的行為 | 高 |
| GOFFEEによるPowerModul・FlashFileGrabber・USB Wormを用いた2024年後半の標的型攻撃 | GOFFEE | FlashFileGrabber, PowerModul, PowerTaskel, USB Worm | 情報なし | T1027 Obfuscated Files or Information, T1036 Masquerading, T1025 Data from Removable Media, T1036.007 Double File Extension, T1218.005 Mshta, T1055 Process Injection, T1091 Replication Through Removable Media, T1566.001 Spearphishing Attachment | 情報なし | 政府・行政, メディア・報道, ロシア, 建設, エネルギー, 情報通信 | 被害事例: GOFFEEによるPowerModul・FlashFileGrabber・USB Wormを用いた2024年後半の標的型攻撃 | 高 |
| GOFFEEによる偽Acrobat Reader更新を用いたWarpRATとPowerTaskel v2の配布 | GOFFEE | PowerTaskel v2, WarpRAT | Inno Setup, Mythic | T1573 Encrypted Channel, T1090 Proxy, T1497 Virtualization/Sandbox Evasion, T1566.002 Spearphishing Link, T1204.002 Malicious File | キャンペーンごとに使い分ける短命ドメイン群, C2 秘匿のためのリバースプロキシ | ロシア, CIS諸国, 欧州, 製造・産業 | 被害事例: GOFFEEによる偽Acrobat Reader更新を用いたWarpRATとPowerTaskel v2の配布 | 高 |
| GOFFEEによるリモートテンプレート・コンテナ環境を用いた2026年第2四半期キャンペーン | GOFFEE | 情報なし | certutil, InstallUtil.exe, mshta.exe, Mythic, pgAdmin, PowerShell | T1105 Ingress Tool Transfer, T1218.004 System Binary Proxy Execution: InstallUtil, T1218.005 System Binary Proxy Execution: Mshta, T1059.001 PowerShell, T1620 Reflective Code Loading, T1221 Template Injection, T1047 Windows Management Instrumentation | キャンペーンごとに使い分ける短命ドメイン群 | ベラルーシ, ロシア, テクノロジー | 情報なし | 高 |
...
| countries | ベラルーシ | Kaspersky states that GOFFEE expanded targeting to Belarus in the Q2 2026 campaign. | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
...
| sectors | テクノロジー | Kaspersky describes Russian technology companies as the primary Q2 2026 targets. | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
...
|---|---|---|---|---|---|---|---|---|---|
| Defense Evasion | T1221 | Template Injection | 2026年第2四半期Campaignでは、SMBまたはWebDAV上のリモートテンプレートを参照する文書を用いて後続コンテンツを取得した。 |  | activity--goffee-q2-container-campaign-2026 | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
| Execution | T1047 | Windows Management Instrumentation | 2026年第2四半期CampaignでWMIを介したプロセス実行が観測された。 |  | activity--goffee-q2-container-campaign-2026 | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
| Execution | T1059.001 | PowerShell | 2026年第2四半期CampaignでPowerShellおよびInvoke-WebRequestを用いてコマンド実行とファイル取得を行った。 |  | activity--goffee-q2-container-campaign-2026 | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
| Command and Control | T1105 | Ingress Tool Transfer | curl、wget、certutil、Invoke-WebRequestを使い、2026年第2四半期Campaignの後続コンポーネントを取得した。 |  | activity--goffee-q2-container-campaign-2026 | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
| Defense Evasion | T1218.005 | System Binary Proxy Execution: Mshta | 攻撃者が持ち込んで改名したmshta.exeを2026年第2四半期CampaignでHTA実行へ用いた。 |  | activity--goffee-q2-container-campaign-2026 | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
| Defense Evasion | T1218.004 | System Binary Proxy Execution: InstallUtil | 2026年第2四半期CampaignでInstallUtil.exeを用いて.NETコードを実行し、サービス永続化へ利用した。 |  | activity--goffee-q2-container-campaign-2026 | 2026-04 | 2026-06 | 高 | `source--kaspersky-goffee-q2-containers-2026` |
| Defense Evasion | T1620 | Reflective Code Loading | Linuxコンテナ内でmemfd_createを用い、ディスクへ通常ファイルを残さず後続コンポーネントをメモリから実行した。 |  | activity--goffee-q2-container-campaign-2026 | 2026-04 | 2026-06 | 中 | `source--kaspersky-goffee-q2-containers-2026` |
...
- Kaspersky は、HeartlessSoul との背後の同一性を中程度の確度で評価する一方、両者のツールセットは大きく異なると明記している。HeartlessSoul は未帰属クラスタ台帳で追跡し、GOFFEE との関係は suspected-shared-operators として構造化した。これは exact identity や alias を意味せず、独立した追加根拠が得られるまではアクタープロファイルへ昇格しない。
...
| source--kaspersky-goffee-q2-containers-2026 | GOFFEE расширяет свои TTP и осваивает контейнеры | Kaspersky GReAT (Securelist) | 2026-07-29 | https://securelist.ru/tr/goffee-new-ttps-and-container-attacks/116431/ | vendor-research | TLP:CLEAR | 高 |
