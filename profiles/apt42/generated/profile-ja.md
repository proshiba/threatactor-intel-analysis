...
|---|---|---|---|---|---|---|---|
| Google、ハッカーがGemini AIを攻撃の全段階で悪用していると指摘 | APT42 | 情報なし | 情報なし | 情報なし | 情報なし | 被害事例: Google、ハッカーがGemini AIを攻撃の全段階で悪用していると指摘 | 中 |
...
|---|---|---|---|---|---|---|
| regions | 中東 | MITRE ATT&CKのGroup概要でAPT42の標的範囲として中東が明示されている。 | 不明 | 不明 | 高 | `source--mitre-attack-19-2` |
