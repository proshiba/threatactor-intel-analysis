...
|---|---|---|---|---|---|---|
| countries | コロンビア | MITRE ATT&CKのGroup概要でBlind Eagleの標的国として明示されている。 | 不明 | 不明 | 高 | `source--mitre-attack-19-2` |
...
| regions | 中南米 | MITRE ATT&CKのGroup概要でBlind Eagleの標的範囲として中南米が明示されている。 | 不明 | 不明 | 高 | `source--mitre-attack-19-2` |
