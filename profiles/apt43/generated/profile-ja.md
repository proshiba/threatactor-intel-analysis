...
| misp-mitre-enterprise-intrusion-set | Kimsuky - G0094 | canonical-name | 高 |  | https://asert.arbornetworks.com/stolen-pencil-campaign-targets-academia/<br>https://attack.mitre.org/groups/G0094<br>https://blog.alyac.co.kr/2234 |
...
| misp-360net | 一致なし |  |  |  |  |
| misp-tidal-groups | Kimsuky | single-alias-intersection | 中 | KP |  |
...
|---|---|---|---|---|---|---|
| countries | 日本 | 活動「北朝鮮のハッカー、弱いDMARCメールポリシーを悪用」の記述で標的として明示された国・地域。 | 不明 | 不明 | 中 | `source--daily-251ff3261ef519dfe8d5` |
| countries | 米国 | 活動「北朝鮮のハッカー、弱いDMARCメールポリシーを悪用」の記述で標的として明示された国・地域。 | 不明 | 不明 | 中 | `source--daily-251ff3261ef519dfe8d5` |
| countries | 韓国 | 活動「北朝鮮のハッカー、弱いDMARCメールポリシーを悪用」の記述で標的として明示された国・地域。 | 不明 | 不明 | 中 | `source--daily-251ff3261ef519dfe8d5`, `source--daily-444c87a0051642065f55` |
| regions | 東アジア | 日本、韓国で確認された標的・被害事例を東アジアとして集約した地域表示。 | 不明 | 不明 | 中 | `source--daily-251ff3261ef519dfe8d5`, `source--daily-444c87a0051642065f55` |
...
- The FBI's January 2026 Kimsuky Quishing FLASH does not itself attribute that specific activity to APT43; cross-vendor overlap is recorded only as a relationship.
