...
| スイス政府はITサプライヤーへのランサムウェア攻撃がデータに影響を及ぼした可能性があると発表。 攻撃はPlayランサムウェアギャングにより行われ、機密データが盗まれたと主張。 スイス政府は、漏洩したデータが連邦行政のものである可能性が高いと述べている。 さらに、スイス政府のウェブサイトとオンラインサービスがDDoS攻撃 | NoName | 情報なし | 情報なし | 情報なし | ロシア, スイス | スイス政府はITサプライヤーへ | 中 |
