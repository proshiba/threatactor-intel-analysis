...
TAG-71の標準化プロファイル。リポジトリ内の専用資料1件とMITRE ATT&CK、アクターマッピング表を基礎情報としている。
...
| source--tag-71--d8bea545069c2c60 | tag 71 |  | 不明 | actor_profile/evidence/tag-71.csv | structured-data | TLP:CLEAR | 中 |
| source--tag-71--17535958404ea20e | threat actor list from cs |  | 不明 | summary/2024/threat actor list from cs.csv | structured-data | TLP:CLEAR | 中 |
