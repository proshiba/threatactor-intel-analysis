...
Blue Mockingbirdの標準化プロファイル。リポジトリ内の専用資料1件とMITRE ATT&CK、アクターマッピング表を基礎情報としている。

## アクター名とAlias

- 正規名: **Blue Mockingbird**
- 初回観測: 不明
- 最終観測: 不明
- 活動状態: unknown
...
| Execution, Persistence, Privilege Escalation | T1053.005 | Scheduled Task | MITRE ATT&CK maps this technique to the actor. |  |  | 不明 | 不明 | 高 | `source--blue-mockingbird--54b9773a7ff20d2c`, `source--mitre-attack-19-1` |
...
| Execution, Stealth | T1574.012 | COR_PROFILER | MITRE ATT&CK maps this technique to the actor. |  |  | 不明 | 不明 | 高 | `source--mitre-attack-19-1` |
