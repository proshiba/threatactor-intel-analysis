...
| PassCV | overlaps-with | 共有alias: Winnti Umbrella | 低 | `source--actor-mapping-workbook` |
...
| countries | 中国 | 構造化OSINTの被害国フィールドでBARIUMの標的・被害国として中国が記録されている。 | 不明 | 不明 | 中 | `source--target-audit-misp-threat-actor` |
