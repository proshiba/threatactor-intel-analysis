...
| UNC6395、Salesloft Drift侵害から顧客SaaSデータ窃取へ展開 | intrusion | 2025-03-22 | 2025-09-05 | 2025-09-06 |  |  |  | victim--activity-rule--1a80c726c6a7162426fd | SalesloftとMandiantの調査では、攻撃者が2025年3月22日から9月5日までDrift環境へ侵入し、GitHub PATによる偵察・リポジトリ取得、AWS環境へのアクセス、OAuthトークン窃取を行った。GTIGは8月8～18日に盗まれたトークンでSalesforce顧客データを大量取得した活動をUNC6395として追跡する。ShinyHuntersやScattered Spiderとの同一性は一次資料が確定していないため本活動の帰属根拠には用いない。 | 高 | `source--daily-5ccc06758fe72e4fc05e`, `source--gtig-unc6395-salesloft-drift-2025`, `source--salesloft-drift-incident-2025` |
| UNC6395、盗難Drift OAuthトークンでSalesforceデータを大量窃取 | infrastructure-operation | 2025-08-08 | 2025-08-18 | 2025-08-26 |  |  | ttp--activity-rule--b489d625786d2bc516b3 | victim--activity-rule--0c6a735d410dbf488002 | SalesloftのDrift-Salesforce連携のOAuth/リフレッシュトークンが盗まれ、顧客環境で窃取に悪用。 攻撃は2025/8/8〜8/18に実施。AWS鍵・パスワード・Snowflakeトークン等の取得を狙う。 Salesloftは全トークンを失効させ再認証を要求。影響は同連携を使う顧客に限定と説明。 GTIGはUNC6395(ShinyHunters)として追跡。SOQLで秘密抽出、インフラを隠すためにTorやAWS・DigitalOceanといったホスティングプロバイダーも利用。 リクエストにはpythonまたはカスタムツール用のUser-Agentが利用されていた。 python-requests/2.32.4、Python/3.11 aiohttp/3.12.15 | 高 | `source--daily-1280007d047388eb38ef`, `source--gtig-unc6395-salesloft-drift-2025` |
...
| UNC6395、Salesloft Drift侵害から顧客SaaSデータ窃取へ展開 | UNC6395 | 情報なし | 情報なし | 情報なし | 情報なし | Salesloft：3月 | 高 |
| UNC6395、盗難Drift OAuthトークンでSalesforceデータを大量窃取 | UNC6395 | 情報なし | T1059.006 Python | 情報なし | 情報なし | Salesloft | 高 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 被害事例: Salesloftが侵害され、Salesforceデータ窃取攻撃用のOAuthトークンが盗まれる | Salesloft | named | organization | reported |  |  | ttp--activity-rule--b489d625786d2bc516b3 | クラウド／SaaS | data-theft: Salesloftが侵害され、Salesforceデータ窃取攻撃用のOAuthトークンが盗まれる | 不明 | 不明 | 2025-08-27 | 中 | `source--daily-1280007d047388eb38ef`, `source--gtig-unc6395-salesloft-drift-2025` |
| 被害事例: Salesloft：3月のGitHubリポジトリ侵害がSalesforceデータ窃取攻撃に発展 | Salesloft：3月 | named | organization | reported |  |  |  | クラウド／SaaS, 開発環境／ソースコード | data-theft: Salesloft：3月のGitHubリポジトリ侵害がSalesforceデータ窃取攻撃に発展 | 不明 | 不明 | 2025-09-09 | 中 | `source--daily-5ccc06758fe72e4fc05e`, `source--gtig-unc6395-salesloft-drift-2025`, `source--salesloft-drift-incident-2025` |
...
| source--gtig-unc6395-salesloft-drift-2025 | Widespread Data Theft Targets Salesforce Instances via Salesloft Drift | Google Threat Intelligence Group / Mandiant | 2025-08-26 | https://cloud.google.com/blog/topics/threat-intelligence/data-theft-salesforce-instances-via-salesloft-drift | vendor-threat-research | TLP:CLEAR | 高 |
| source--salesloft-drift-incident-2025 | Update on Mandiant Drift and Salesloft Application Investigations | Salesloft | 2025-09-06 | https://trust.salesloft.com/?uid=Drift%2FSalesforce+Security+Update | first-party-incident-disclosure | TLP:CLEAR | 高 |
