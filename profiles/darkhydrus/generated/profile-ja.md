...
| 対象 | 関係 | 説明 | 確度 | 証拠 |
|---|---|---|---|---|
| CopyKittens | overlaps-with | 共有alias: DarkHydrus | 低 | `source--mitre-attack-19-2` |
...
|---|---|---|---|---|---|---|
| regions | 中東 | MITRE ATT&CKのGroup概要でDarkHydrusの標的範囲として中東が明示されている。 | 不明 | 不明 | 高 | `source--mitre-attack-19-2` |
