...
|---|---|---|---|---|---|---|---|
| Microsoftがウクライナへの攻撃で悪用されたWindowsのゼロデイ脆弱性を修正 | UAC-0194 | 情報なし | T1566.002 Spearphishing Link | 情報なし | ウクライナ, 教育・研究 | 被害事例: Microsoftがウクライナへの攻撃で悪用されたWindowsのゼロデイ脆弱性を修正 | 中 |
