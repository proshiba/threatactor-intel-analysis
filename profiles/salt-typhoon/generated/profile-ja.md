...
| Salt Typhoon、通信事業者のネットワーク機器でJumbledPathを使用 | cyber-espionage | 不明 | 不明 | 2025-02-20 | target--activity-rule--sector--97fa6f38a056d42117be, target--mitre-group--country--41795735fc0e57933c4e | malware--jumbledpath |  | victim--activity-rule--0dca98f829c8d2966945 | Cisco Talosは、Salt Typhoonが米国の大手通信事業者を侵害し、盗取した正規資格情報で複数ベンダーのネットワーク機器へ長期間アクセスしたと報告した。攻撃者は設定情報や認証トラフィックを収集し、侵害機器を踏み台として横展開した。Go製ELFユーティリティJumbledPathは、離れたCisco機器でパケットキャプチャを実行し、経路上のログを消去・阻害して暗号化済み取得データを返送するために使われた。 | 高 | `source--cisco-talos-salt-typhoon-jumbledpath-2025` |
...
| Salt Typhoon、通信事業者のネットワーク機器でJumbledPathを使用 | Salt Typhoon | JumbledPath | 情報なし | 情報なし | 情報通信, 米国 | 被害事例: Salt Typhoon、通信事業者のネットワーク機器でJumbledPathを使用 | 高 |
| 中国、米国の通信企業9社をハッキング、CharterやWindstreamも被害 | Salt Typhoon | 情報なし | 情報なし | 情報なし | 米国 | 被害事例: 中国、米国の通信企業9社をハッキング、CharterやWindstreamも被害 | 中 |
| ホワイトハウスが9件目の通信事業者侵害を中国ハッカーに関連付ける | Salt Typhoon | 情報なし | 情報なし | 情報なし | 政府・行政, 米国, 東南アジア | 被害事例: ホワイトハウスが9件目の通信事業者侵害を中国ハッカーに関連付ける | 中 |
| FCC、Salt Typhoon攻撃を受けた通信ネットワークの保護を命令 | Salt Typhoon | 情報なし | 情報なし | 情報なし | 政府・行政, 米国 | 被害事例: FCC、Salt Typhoon攻撃を受けた通信ネットワークの保護を命令 | 高 |
...
| 中国のハッカー、未修正のCiscoルーターを通じて米国の通信事業者をさらに侵害 | Salt Typhoon | 情報なし | T1190 Exploit Public-Facing Application | 情報なし | インド, 英国, 情報通信, 米国, 南米 | 被害事例: 中国のハッカー、未修正のCiscoルーターを通じて米国の通信事業者をさらに侵害 | 中 |
...
|---|---|---|---|---|---|---|
| countries | インド | 活動「中国のハッカー、未修正のCiscoルーターを通じて米国の通信事業者をさらに侵害」の記述で標的として明示された国・地域。 | 2024-12 | 2025-01 | 中 | `source--daily-f6737c6dffa112b7b406` |
| countries | カナダ | 活動「中国系ハッカーが米政府関係者の通信を最近の通信会社の侵害で傍受」の記述で標的として明示された国・地域。 | 不明 | 不明 | 中 | `source--daily-66a6db2a9826ffe94b34` |
| countries | 米国 | [Salt Typhoon](https://attack.mitre.org/groups/G1045) is a People's Republic of China (PRC) state-backed actor that has been active since at least 2019 and responsible for numerous compromises of network infrastructure at major U.S. telecommunication and internet service providers (ISP).(Citation: US Dept. | 2024-12 | 2025-01 | 高 | `source--cisco-talos-salt-typhoon-jumbledpath-2025`, `source--daily-109114cb275f6abbc31b`, `source--daily-201526278f12b51ceb69`, `source--daily-6148d7a5b4eb95ec4071`, `source--daily-6489f1d71026c247f5db`, `source--daily-66a6db2a9826ffe94b34`, `source--daily-783a5f048c1b5f5d1e87`, `source--daily-8261fb78f465363bd3b1`, `source--daily-8e9e2a4c037c66bd65a0`, `source--daily-8f2935254e84a399c0e6`, `source--daily-a83c00a6ec644814b818`, `source--daily-ee88cbba9f3a1d88bf3a`, `source--daily-f6737c6dffa112b7b406`, `source--mitre-attack-19-2` |
...
| regions | 北米 | カナダ、米国で確認された標的・被害事例を北米として集約した地域表示。 | 不明 | 不明 | 中 | `source--cisco-talos-salt-typhoon-jumbledpath-2025`, `source--daily-109114cb275f6abbc31b`, `source--daily-201526278f12b51ceb69`, `source--daily-6148d7a5b4eb95ec4071`, `source--daily-6489f1d71026c247f5db`, `source--daily-66a6db2a9826ffe94b34`, `source--daily-783a5f048c1b5f5d1e87`, `source--daily-8261fb78f465363bd3b1`, `source--daily-8e9e2a4c037c66bd65a0`, `source--daily-8f2935254e84a399c0e6`, `source--daily-a83c00a6ec644814b818`, `source--daily-ee88cbba9f3a1d88bf3a`, `source--daily-f6737c6dffa112b7b406`, `source--mitre-attack-19-2` |
| regions | 南米 | 活動「中国のハッカー、未修正のCiscoルーターを通じて米国の通信事業者をさらに侵害」の記述で標的地域として南米が明示されている。 | 2024-12 | 2025-01 | 中 | `source--daily-f6737c6dffa112b7b406` |
| regions | 東南アジア | 活動「ホワイトハウスが9件目の通信事業者侵害を中国ハッカーに関連付ける」の記述で標的地域として東南アジアが明示されている。 | 不明 | 不明 | 中 | `source--daily-6489f1d71026c247f5db` |
...
| sectors | 情報通信 | 活動「米国、最近の通信事業者侵害に関与したハッカーを阻止するための対策を共有」の記述で標的として明示された産業。 | 2024-12 | 2025-01 | 中 | `source--cisco-talos-salt-typhoon-jumbledpath-2025`, `source--daily-201526278f12b51ceb69`, `source--daily-66a6db2a9826ffe94b34`, `source--daily-783a5f048c1b5f5d1e87`, `source--daily-8261fb78f465363bd3b1`, `source--daily-8e9e2a4c037c66bd65a0`, `source--daily-a83c00a6ec644814b818`, `source--daily-b63b619b8242c38ce6a8`, `source--daily-f2e6a61340cf29da66e3`, `source--daily-f6737c6dffa112b7b406` |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 被害事例: ホワイトハウス：Salt Typhoon、中国のハッカーが数十か国の通信会社を侵害 | 非公開 | aggregate | multiple-organizations | reported | target--activity-rule--sector--97fa6f38a056d42117be, target--mitre-group--country--41795735fc0e57933c4e |  |  |  |  | 不明 | 不明 | 2024-12-06 | 高 | `source--daily-a83c00a6ec644814b818` |
| 被害事例: Salt Typhoon、通信事業者のネットワーク機器でJumbledPathを使用 | 非公開 | aggregate | multiple-organizations | reported | target--activity-rule--sector--97fa6f38a056d42117be, target--mitre-group--country--41795735fc0e57933c4e | malware--jumbledpath |  | ネットワーク機器 |  | 不明 | 不明 | 2025-02-20 | 高 | `source--cisco-talos-salt-typhoon-jumbledpath-2025` |
...
| 被害事例: ホワイトハウスが9件目の通信事業者侵害を中国ハッカーに関連付ける | 非公開 | aggregate | multiple-organizations | reported | target--activity-rule--sector--210dddb39397dbe50e91, target--mitre-group--country--41795735fc0e57933c4e |  |  |  | espionage: Salt Typhoonは、東南アジアを中心に政府機関や通信企業を狙うサイバー諜報活動グループ。 | 不明 | 不明 | 2024-12-29 | 中 | `source--daily-6489f1d71026c247f5db` |
...
| 被害事例: ワイデン議員、Salt Typhoonハッキング後の米国通信網保護法案を提案 | 非公開 | anonymous | unknown | reported | target--mitre-group--country--41795735fc0e57933c4e |  |  |  |  | 不明 | 不明 | 2024-12-12 | 高 | `source--daily-109114cb275f6abbc31b` |
...
| 被害事例: テレコム攻撃後、CISAがSignalのような暗号化メッセージングアプリへの移行を推奨 | 非公開 | anonymous | unknown | reported | target--mitre-group--country--41795735fc0e57933c4e |  |  | VPN／リモートアクセス機器 |  | 不明 | 不明 | 2024-12-19 | 中 | `source--daily-8f2935254e84a399c0e6` |
...
| 被害事例: FCC、Salt Typhoon攻撃を受けた通信ネットワークの保護を命令 | 非公開 | aggregate | multiple-organizations | reported | target--activity-rule--sector--210dddb39397dbe50e91, target--mitre-group--country--41795735fc0e57933c4e |  |  | ネットワーク機器 |  | 不明 | 不明 | 2025-01-18 | 高 | `source--daily-ee88cbba9f3a1d88bf3a` |
