# sTOrm-0133 脅威アクタープロファイル

- プロファイルID: `actor--storm-0133`
- 状態: draft
...
sTOrm-0133の標準化プロファイル。リポジトリ内の専用資料1件とMITRE ATT&CK、アクターマッピング表を基礎情報としている。
...
|---|---|---|---|---|---|---|
| countries | イスラエル | 構造化OSINTの被害国フィールドでsTOrm-0133の標的・被害国としてイスラエルが記録されている。 | 不明 | 不明 | 中 | `source--target-audit-misp-threat-actor` |
| regions | 中東 | 構造化OSINTの被害地域フィールドでsTOrm-0133の標的範囲として中東が記録されている。 | 不明 | 不明 | 中 | `source--target-audit-misp-threat-actor` |
...
| source--storm-0133--03486bd7f176c00f | storm 0133 |  | 不明 | actor_profile/evidence/storm-0133.csv | structured-data | TLP:CLEAR | 中 |
| source--storm-0133--6160881979fbc83d | tool of first resort israel hamas war cyber |  | 不明 | summary/2024/tool-of-first-resort-israel-hamas-war-cyber.pdf | report | TLP:CLEAR | 中 |
