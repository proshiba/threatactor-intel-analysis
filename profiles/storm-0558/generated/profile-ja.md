...
|---|---|---|---|---|---|---|---|
| マイクロソフト、2023年のExchange攻撃でハッカーがMSAキーを盗んだ方法が未だに不明 | Storm-0558 | 情報なし | 情報なし | 情報なし | 米国 | 被害事例: マイクロソフト、2023年のExchange攻撃でハッカーがMSAキーを盗んだ方法が未だに不明 | 中 |
...
|---|---|---|---|---|---|---|
| countries | ドイツ | 構造化OSINTの被害国フィールドでStorm-0558の標的・被害国としてドイツが記録されている。 | 不明 | 不明 | 中 | `source--target-audit-misp-threat-actor` |
| countries | 米国 | 活動「マイクロソフト、2023年のExchange攻撃でハッカーがMSAキーを盗んだ方法が未だに不明」の記述で標的として明示された国・地域。 | 不明 | 不明 | 中 | `source--daily-bbafe9c31bcf2d45a64d`, `source--target-audit-etda-threat-group-cards`, `source--target-audit-misp-threat-actor` |
| regions | 欧州 | 構造化OSINTの被害地域フィールドでStorm-0558の標的範囲として欧州が記録されている。 | 不明 | 不明 | 中 | `source--target-audit-etda-threat-group-cards` |
