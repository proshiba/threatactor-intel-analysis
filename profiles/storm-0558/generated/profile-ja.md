...
|---|---|---|---|---|---|---|---|
| マイクロソフト、2023年のExchange攻撃でハッカーがMSAキーを盗んだ方法が未だに不明 | cyber-espionage | 不明 | 不明 | 2024-04-05 | 米国国土安全保障省のCSRBがマイクロソフトの対応を批判 ハッカーはエンジニアのラップトップからAzure署名キーを盗んだと考えられる 攻撃は中国のサイバー諜報活動グループ「Storm-0558」によるもの マイクロソフトは署名キーの盗難方法について確たる証拠がないと述べている ハッカーはこの侵害で、22組織から500以上の個人のメールアカウントを侵害した | 中 | `source--daily-bbafe9c31bcf2d45a64d` |
