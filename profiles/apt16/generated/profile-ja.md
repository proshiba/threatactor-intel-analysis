...
|---|---|---|---|---|---|---|
| countries | 台湾 | [APT16](https://attack.mitre.org/groups/G0023) is a China-based threat group that has launched spearphishing campaigns targeting Japanese and Taiwanese organizations. | 不明 | 不明 | 高 | `source--mitre-attack-19-2` |
| countries | 日本 | [APT16](https://attack.mitre.org/groups/G0023) is a China-based threat group that has launched spearphishing campaigns targeting Japanese and Taiwanese organizations. | 不明 | 不明 | 高 | `source--mitre-attack-19-2` |
| regions | 東アジア | 台湾、日本で確認された標的・被害事例を東アジアとして集約した地域表示。 | 不明 | 不明 | 中 | `source--mitre-attack-19-2` |
