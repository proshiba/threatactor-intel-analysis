...
|---|---|---|---|---|---|
| Pitty Panda | catalog | overlapping | 中 | `source--actor-mapping-workbook` | Alias scope must be reviewed before publication. |
...
| 対象 | 関係 | 説明 | 確度 | 証拠 |
|---|---|---|---|---|
| Calypso | overlaps-with | 共有alias: Pitty Tiger, PittyTiger | 低 | `source--mitre-attack-19-1`, `source--actor-mapping-workbook` |

## ダイヤモンドモデル

| 要素 | 内容 |
|---|---|
| Adversary | [PittyTiger](https://attack.mitre.org/groups/G0011) is a threat group believed to operate out of China that uses multiple different types of malware to maintain command and control.(Citation: Bizeul 2014)(Citation: Villeneuve 2014) |
| Capability | Lurid, gh0st RAT, PoisonIvy, PittyTiger, Paladin RAT, Mimikatz, gsecdump |
| Infrastructure |  |
| Victim |  |
| Socio-political |  |
...
| misp-mitre-enterprise-intrusion-set | PittyTiger - G0011 | mitre-external-id | 高 |  | https://attack.mitre.org/wiki/Group/G0011<br>http://blog.cassidiancybersecurity.com/post/2014/07/The-Eye-of-the-Tiger2<br>https://www.fireeye.com/blog/threat-research/2014/07/spy-of-the-tiger.html |
...
|---|---|---|---|---|---|---|
| malware--lurid | Lurid | [Lurid](https://attack.mitre.org/software/S0010) is a malware family that has been used by several groups, including [PittyTiger](https://attack.mitre.org/groups/G0011), in targeted attacks as far back as 2006. (Citation: Villeneuve 2014) (Citation: Villeneuve 2011) | 不明 | 不明 | 高 | `source--mitre-attack-19-1` |
...
| malware--pittytiger | PittyTiger | The actor-mapping workbook lists this software or tool. | 不明 | 不明 | 中 | `source--actor-mapping-workbook` |
| malware--paladin-rat | Paladin RAT | The actor-mapping workbook lists this software or tool. | 不明 | 不明 | 中 | `source--actor-mapping-workbook` |
...
|---|---|---|---|---|---|---|
| countries | 台湾 | 構造化OSINTの被害国フィールドでPittyTigerの標的・被害国として台湾が記録されている。 | 不明 | 不明 | 中 | `source--target-audit-etda-threat-group-cards` |
| regions | 欧州 | 構造化OSINTの被害地域フィールドでPittyTigerの標的範囲として欧州が記録されている。 | 不明 | 不明 | 中 | `source--target-audit-etda-threat-group-cards` |
