...
| Credential Access, Defense Impairment, Persistence | T1556 | Modify Authentication Process | MITRE ATT&CK maps this technique to the actor. |  |  | 不明 | 不明 | 高 | `source--mitre-attack-19-1` |
...
| Impact | T1565 | Data Manipulation | MITRE ATT&CK maps this technique to the actor. |  |  | 不明 | 不明 | 高 | `source--mitre-attack-19-1` |
