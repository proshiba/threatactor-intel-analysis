...
| malware--daily-639898b8bf5cd6e74b68 | AsyncRAT | Kimsukyとの直接的な利用関係が一次資料レビューで確認されたマルウェア。 | 不明 | 不明 | 中 | `source--daily-4f957481b39f57505e29` |
...
| またKimsuky？今度は水産食材の購入依頼書を装う | reported-activity | 不明 | 不明 | 2026-09-12 | target--south-korea |  | ttp--activity-rule--3a9a5683cbb2d30c608c, ttp--activity-rule--6a6097cb7c35cf869e77, ttp--activity-rule--aed8cb1679e336255a93 | victim--activity-rule--b702fb8c8d0005882475 | AhnLabは、韓国国内のユーザーを標的に、水産食材の購入依頼書を装った悪性LNKファイルが配布されていることを確認した。 LNK実行時には正常なHWP文書を表示する一方、PowerShellで悪性スクリプトを展開し、タスクスケジューラへ登録して約14分ごとに実行する。 termsvc.ps1はOS、タイムゾーン、グローバルIP、ユーザー・ドメイン、プロセス、コンピューター名などの感染端末情報を収集する。 収集情報はBackblaze B2へ送信され、同サービスをC&Cとして利用して追加コマンドを取得・実行した後、関連ファイルを削除して痕跡を減らす。 PowerShell構文、LNK内部データの抽出方法、タスク登録などが過去の攻撃と類似しており、AhnLabは今回の活動をKimsukyと関連すると判断した。 | 中 | `source--daily-ad51c0d6f2257de0c711` |
...
| Kimsukyグループによる外交関係者を装った攻撃事例（PebbleDash、PrxClient） | phishing-campaign | 不明 | 不明 | 2026-07-30 |  | malware--daily-36c21f1c91a9419fec3b | ttp--activity-rule--2a5905a957c32a7e3b18, ttp--activity-rule--2c59ecf18e0070cc1ae3, ttp--activity-rule--33fdc70040c423e5f805, ttp--activity-rule--8b4b449172618d50d52f, ttp--activity-rule--e03d124b209ac4d05bf5 | victim--activity-rule--b9b706ac581ead490673 | Kimsukyは外交関係者を装ったスピアフィッシングで悪性LNKを配布し、PebbleDashやPrxClientなど複数のツールを導入している。 LNKはPowerShell、JavaScript、HTAを実行し、追加ペイロードの取得、端末情報の収集、ファイルの窃取を行う。 PebbleDashはコマンド実行、ファイル操作、プロセス制御、システム情報収集などを備え、LSASSへ注入される亜種も確認された。 攻撃者はRDP Wrapper、バックドアアカウント、RDP Patcherを使い、感染端末への継続的な遠隔アクセスを確保していた。 | 高 | `source--daily-6f6e88199bc7e8479193` |
...
| Kimsuky、AI生成の囮文書からローカルLLMまで攻撃活動へAIを統合 | infrastructure-operation | 不明 | 不明 | 2026-08-11 |  | malware--daily-639898b8bf5cd6e74b68 | ttp--activity-rule--a52ac96d471f7be94e22, ttp--activity-rule--c9f49084b8203a3ac879 |  | Geniansは、北朝鮮偵察総局傘下とされるKimsukyがGitHub・GitLabをC2や配布基盤として悪用する「Operation GitPower」を継続していると報告した。 攻撃はZIP内の悪意あるLNKからPowerShellを実行し、正規PDFを表示する裏で情報収集、スケジュールタスクによる永続化、AsyncRAT展開を行う。 2026年以降は暗号資産・金融などを題材とする生成AI製と評価された高品質な囮文書を利用し、ソーシャルエンジニアリングを高度化している。 攻撃者環境にはOllama、GPT4All、Msty、RAG、Cursor、AIエージェント開発ライブラリ、Whisperなどの導入・利用痕跡が確認された。 独自AIモデルを訓練した証拠はなく、既存AIをマルウェア開発、窃取データ分析、攻撃自動化へ統合するための研究・能力蓄積段階と評価されている。 | 中 | `source--daily-4f957481b39f57505e29` |
...
| 北東アジアを狙うKimsukyによる正規リモート制御ツール悪用攻撃の内部 | phishing-campaign | 2026-01 | 2026-06 | 2026-08-25 | target--activity-rule--country--f35cd09db0a72555b38a, target--south-korea |  | ttp--activity-rule--5c96d9562d68fe5dc3fc, ttp--activity-rule--fd4f1b806dc0ccedc354 | victim--activity-rule--9afc3575df0624a5afbb | ENKI WhiteHatは2026年前半、日本と韓国を標的にOneDrive共有リンクと悪意あるLNKを配布するKimsukyのスピアフィッシング攻撃を確認した。 LNK実行後はVBEとPowerShellを展開し、15分間隔のタスクでC2から命令を取得して、システム情報、Outlook／Thunderbirdメール、キー入力を窃取する。 攻撃者はChrome Remote DesktopとAnyDeskを正規ツールとして導入し、アンチウイルス検知を回避しながら複数の遠隔操作経路を確保した。 Gmailの送受信メールと添付ファイルを自動窃取する悪意あるChrome拡張機能も導入され、コードには生成AI利用を示唆する韓国語コメントなどが多数存在した。 攻撃基盤は短期間でC2をローテーションし、侵害した韓国の正規サーバーや日本の無料ホスティングも悪用して追跡を困難にしていた。 | 中 | `source--daily-540b98540d06df59f254` |
...
| またKimsuky？今度は水産食材の購入依頼書を装う | Kimsuky | 情報なし | T1057 Process Discovery, T1204.002 Malicious File, T1053.005 Scheduled Task | 情報なし | 韓国 | 被害事例: またKimsuky？今度は水産食材の購入依頼書を装う | 中 |
...
| Kimsukyグループによる外交関係者を装った攻撃事例（PebbleDash、PrxClient） | Kimsuky | PrxClient | T1083 File and Directory Discovery, T1059.007 JavaScript, T1082 System Information Discovery, T1105 Ingress Tool Transfer, T1057 Process Discovery | 情報なし | 情報なし | 被害事例: Kimsukyグループによる外交関係者を装った攻撃事例（PebbleDash、PrxClient） | 高 |
...
| Kimsuky、AI生成の囮文書からローカルLLMまで攻撃活動へAIを統合 | Kimsuky | AsyncRAT | T1053.005 Scheduled Task, T1102.003 One-Way Communication | Cloud and Code Hosting Services | 情報なし | 情報なし | 中 |
...
| 北東アジアを狙うKimsukyによる正規リモート制御ツール悪用攻撃の内部 | Kimsuky | 情報なし | T1219.002 Remote Desktop Software, T1566.002 Spearphishing Link | Cloud and Code Hosting Services | 日本, 韓国 | 被害事例: 北東アジアを狙うKimsukyによる正規リモート制御ツール悪用攻撃の内部 | 中 |
...
| countries | 日本 | 活動「日本、北朝鮮のKimsukyハッカーに関連する攻撃を警告」の記述で標的として明示された国・地域。 | 2026-01 | 2026-06 | 中 | `source--daily-00bf22365ce019ee25a6`, `source--daily-540b98540d06df59f254`, `source--daily-d930e3ca01c519bf5740`, `source--target-audit-etda-threat-group-cards` |
...
| countries | 韓国 | 最重要の継続的対象。 | 2012 | 2026-06 | 高 | `source--daily-00bf22365ce019ee25a6`, `source--daily-01bbfa4ce1d271e9e220`, `source--daily-0477636fe03aea54224d`, `source--daily-444c87a0051642065f55`, `source--daily-540b98540d06df59f254`, `source--daily-a5ca98841868974d600b`, `source--daily-ad51c0d6f2257de0c711`, `source--daily-b9be11e58ab6c82617ab`, `source--daily-f05f4888998c8f53f5ca`, `source--joint-csa-2023`, `source--mitre-attack-19-1`, `source--rapid7-2024`, `source--target-audit-etda-threat-group-cards` |
...
| 被害事例: 北東アジアを狙うKimsukyによる正規リモート制御ツール悪用攻撃の内部 | 非公開 | aggregate | multiple-organizations | reported | target--activity-rule--country--f35cd09db0a72555b38a, target--south-korea |  | ttp--activity-rule--5c96d9562d68fe5dc3fc, ttp--activity-rule--fd4f1b806dc0ccedc354 | メール／メールアカウント, サーバー | data-theft: Gmailの送受信メールと添付ファイルを自動窃取する悪意あるChrome拡張機能も導入され、コードには生成AI利用を示唆する韓国語コメントなどが多数存在した。 | 2026-01 | 2026-06 | 2026-08-25 | 中 | `source--daily-540b98540d06df59f254` |
...
| 被害事例: またKimsuky？今度は水産食材の購入依頼書を装う | 非公開 | aggregate | multiple-organizations | reported | target--south-korea |  | ttp--activity-rule--3a9a5683cbb2d30c608c, ttp--activity-rule--6a6097cb7c35cf869e77, ttp--activity-rule--aed8cb1679e336255a93 | エンドポイント |  | 不明 | 不明 | 2026-09-12 | 中 | `source--daily-ad51c0d6f2257de0c711` |
| 被害事例: Kimsukyグループによる外交関係者を装った攻撃事例（PebbleDash、PrxClient） | 非公開 | aggregate | multiple-organizations | reported |  | malware--daily-36c21f1c91a9419fec3b | ttp--activity-rule--2a5905a957c32a7e3b18, ttp--activity-rule--2c59ecf18e0070cc1ae3, ttp--activity-rule--33fdc70040c423e5f805, ttp--activity-rule--8b4b449172618d50d52f, ttp--activity-rule--e03d124b209ac4d05bf5 | エンドポイント | data-theft: LNKはPowerShell、JavaScript、HTAを実行し、追加ペイロードの取得、端末情報の収集、ファイルの窃取を行う。<br>espionage: PebbleDashはコマンド実行、ファイル操作、プロセス制御、システム情報収集などを備え、LSASSへ注入される亜種も確認された。 | 不明 | 不明 | 2026-07-30 | 高 | `source--daily-6f6e88199bc7e8479193` |
...
| Discovery | T1083 | File and Directory Discovery | PebbleDashはコマンド実行、ファイル操作、プロセス制御、システム情報収集などを備え、LSASSへ注入される亜種も確認された。 |  | activity--daily-2f12e771b5227843f161 | 不明 | 不明 | 中 | `source--daily-6f6e88199bc7e8479193` |
| Execution | T1059.007 | JavaScript | LNKはPowerShell、JavaScript、HTAを実行し、追加ペイロードの取得、端末情報の収集、ファイルの窃取を行う。 |  | activity--daily-2f12e771b5227843f161 | 不明 | 不明 | 中 | `source--daily-6f6e88199bc7e8479193` |
...
| Discovery | T1082 | System Information Discovery | PebbleDashはコマンド実行、ファイル操作、プロセス制御、システム情報収集などを備え、LSASSへ注入される亜種も確認された。 |  | activity--daily-2f12e771b5227843f161 | 不明 | 不明 | 中 | `source--daily-6f6e88199bc7e8479193` |
| Discovery | T1057 | Process Discovery | termsvc.ps1はOS、タイムゾーン、グローバルIP、ユーザー・ドメイン、プロセス、コンピューター名などの感染端末情報を収集する。 |  | activity--daily-0ba9f1cf5447b3f22da4 | 不明 | 不明 | 中 | `source--daily-ad51c0d6f2257de0c711` |
...
| Command And Control | T1219.002 | Remote Desktop Software | 攻撃者はChrome Remote DesktopとAnyDeskを正規ツールとして導入し、アンチウイルス検知を回避しながら複数の遠隔操作経路を確保した。 |  | activity--daily-8b8c4c1cb83de0464c0b | 2026-01 | 2026-06 | 中 | `source--daily-540b98540d06df59f254` |
| Execution | T1204.002 | Malicious File | AhnLabは、韓国国内のユーザーを標的に、水産食材の購入依頼書を装った悪性LNKファイルが配布されていることを確認した。 LNK実行時には正常なHWP文書を表示する一方、PowerShellで悪性スクリプトを展開し、タスクスケジューラへ登録して約14分ごとに実行する。 |  | activity--daily-0ba9f1cf5447b3f22da4 | 不明 | 不明 | 中 | `source--daily-ad51c0d6f2257de0c711` |
...
| Command And Control | T1105 | Ingress Tool Transfer | LNKはPowerShell、JavaScript、HTAを実行し、追加ペイロードの取得、端末情報の収集、ファイルの窃取を行う。 |  | activity--daily-2f12e771b5227843f161 | 不明 | 不明 | 中 | `source--daily-6f6e88199bc7e8479193` |
...
| Execution, Persistence, Privilege Escalation | T1053.005 | Scheduled Task | 攻撃はZIP内の悪意あるLNKからPowerShellを実行し、正規PDFを表示する裏で情報収集、スケジュールタスクによる永続化、AsyncRAT展開を行う。 | malware--daily-639898b8bf5cd6e74b68 | activity--daily-8646cea6212e48f77baa | 不明 | 不明 | 中 | `source--daily-4f957481b39f57505e29` |
...
| Execution, Persistence, Privilege Escalation | T1053.005 | Scheduled Task | LNK実行時には正常なHWP文書を表示する一方、PowerShellで悪性スクリプトを展開し、タスクスケジューラへ登録して約14分ごとに実行する。 |  | activity--daily-0ba9f1cf5447b3f22da4 | 不明 | 不明 | 中 | `source--daily-ad51c0d6f2257de0c711` |
| Command And Control | T1102.003 | One-Way Communication | Geniansは、北朝鮮偵察総局傘下とされるKimsukyがGitHub・GitLabをC2や配布基盤として悪用する「Operation GitPower」を継続していると報告した。 |  | activity--daily-8646cea6212e48f77baa | 不明 | 不明 | 中 | `source--daily-4f957481b39f57505e29` |
...
| Discovery | T1057 | Process Discovery | PebbleDashはコマンド実行、ファイル操作、プロセス制御、システム情報収集などを備え、LSASSへ注入される亜種も確認された。 |  | activity--daily-2f12e771b5227843f161 | 不明 | 不明 | 中 | `source--daily-6f6e88199bc7e8479193` |
...
| Initial Access | T1566.002 | Spearphishing Link | ENKI WhiteHatは2026年前半、日本と韓国を標的にOneDrive共有リンクと悪意あるLNKを配布するKimsukyのスピアフィッシング攻撃を確認した。 |  | activity--daily-8b8c4c1cb83de0464c0b | 2026-01 | 2026-06 | 中 | `source--daily-540b98540d06df59f254` |
...
| source--daily-4f957481b39f57505e29 | Kimsuky、AI生成の囮文書からローカルLLMまで攻撃活動へAIを統合 | genians.co.kr | 2026-08-11 | https://www.genians.co.kr/en/blog/threat_intelligence/kimsuky_ai_llm | osint-report | TLP:CLEAR | 中 |
| source--daily-540b98540d06df59f254 | 北東アジアを狙うKimsukyによる正規リモート制御ツール悪用攻撃の内部 | enki.co.kr | 2026-08-25 | https://www.enki.co.kr/en/media-center/blog/inside-kimsuky-s-abuse-of-legitimate-remote-control-tools-across-northeast-asia | osint-report | TLP:CLEAR | 中 |
...
| source--daily-ad51c0d6f2257de0c711 | またKimsuky？今度は水産食材の購入依頼書を装う | asec.ahnlab.com | 2026-09-12 | https://asec.ahnlab.com/jp/95367/ | osint-report | TLP:CLEAR | 中 |
